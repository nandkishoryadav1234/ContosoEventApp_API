...
namespace ContosoEventApp.Controllers
{
    ...
    public class ShowsController : ControllerBase
    {
        ...
        public ShowsController(ContosoEventAppContext context)
        {
            _context = context;
        }
        ...
        // GET: api/Shows/name
        [HttpGet("{name}")]
        public async Task<ActionResult<Show>> GetShow(string name)
        {
            var show = await _context.Show.FindAsync(name);
